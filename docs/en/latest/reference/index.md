...
| Parameters | [`Path`](./parameters#symbol-path), [`Query`](./parameters#symbol-query), [`Body`](./parameters#symbol-body), [`Header`](./parameters#symbol-header), [`Cookie`](./parameters#symbol-cookie) |
